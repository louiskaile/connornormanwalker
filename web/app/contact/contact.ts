...
export async function getContactDetails() {
  const page = await client.fetch<ContactPageData>(CONTACT_PAGE_QUERY).catch(() => null)
  return page?.contactDetails?.length ? page.contactDetails : defaultContactDetails
}
